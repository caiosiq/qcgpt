# qcgpt/models/policy.py
import torch
import torch.nn as nn
from typing import Tuple

from ..gates import TOKEN_TO_ID, PAD_ID
from .transformer import SpecEncoder, CircuitDecoder
...
class CircuitPolicy(nn.Module):
    def __init__(self, vocab_size: int,
        ...
        self.decoder = CircuitDecoder(vocab_size, d_model, n_layers, n_heads, max_circ_len)
